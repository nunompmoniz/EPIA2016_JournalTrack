...
myWF <- function(form,train,test,nws,trainer,...) {
  ...
  #PREDICTIONS
  model <- runWorkflow(wf,TimesPublishedTwitter ~ ., train, test)
  ...
  #INFORMATION RETURN
  res <- list(eval_2=stats,predictions=predictions)
  res
...
exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ .,frame_train.headline.economy),
                             c(Workflow("myWF.time", nws=news, frm=frame_train.headline.economy),
                               Workflow("myWF.source", nws=news, frm=frame_train.headline.economy)),
...
exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ .,frame_train.headline.microsoft),
                             c(Workflow("myWF.time", nws=news, frm=frame_train.headline.microsoft),
                               Workflow("myWF.source", nws=news, frm=frame_train.headline.microsoft)),
                             EstimationTask("totTime",method=MonteCarlo(nReps=50,szTrain=.5,szTest=.25))
)

exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ .,frame_train.headline.obama),
                             c(Workflow("myWF.time", nws=news, frm=frame_train.headline.obama),
                               Workflow("myWF.source", nws=news, frm=frame_train.headline.obama)),
                             EstimationTask("totTime",method=MonteCarlo(nReps=50,szTrain=.5,szTest=.25))
)
...
exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ ., frame_train.headline.economy),
                             c(Workflow("myWF", nws=news, trainer="mc.lm_SMOTE"),
                               Workflow("myWF", nws=news, trainer="mc.lm_UNDER"),
                               Workflow("myWF", nws=news, trainer="mc.lm_OVER"),
                               Workflow("myWF", nws=news, trainer="mc.lm_IS")),
                             EstimationTask("totTime",method=MonteCarlo(nReps=50,szTrain=.5,szTest=.25))
)
...
exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ ., frame_train.headline.economy),
                             c(Workflow("myWF", nws=news, trainer="mc.svm_SMOTE"),
                               Workflow("myWF", nws=news, trainer="mc.svm_UNDER"),
                               Workflow("myWF", nws=news, trainer="mc.svm_OVER"),
                               Workflow("myWF", nws=news, trainer="mc.svm_IS")),
                             EstimationTask("totTime",method=MonteCarlo(nReps=50,szTrain=.5,szTest=.25))
)
...
exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ ., frame_train.headline.economy),
                             c(Workflow("myWF", nws=news, trainer="mc.mars_SMOTE"),
                               Workflow("myWF", nws=news, trainer="mc.mars_UNDER"),
                               Workflow("myWF", nws=news, trainer="mc.mars_OVER"),
                               Workflow("myWF", nws=news, trainer="mc.mars_IS")),
                             EstimationTask("totTime",method=MonteCarlo(nReps=50,szTrain=.5,szTest=.25))
)
...
exp <- performanceEstimation(PredTask(TimesPublishedTwitter ~ ., frame_train.headline.economy),
                             c(Workflow("myWF", nws=news, trainer="mc.rf_SMOTE"),
                               Workflow("myWF", nws=news, trainer="mc.rf_UNDER"),
                               Workflow("myWF", nws=news, trainer="mc.rf_OVER"),
                               Workflow("myWF", nws=news, trainer="mc.rf_IS")),
                             EstimationTask("totTime",method=MonteCarlo(nReps=50,szTrain=.5,szTest=.25))
)
