...
mc.lm_SMOTE <- function(form,train,test,un,ov,...) {
...
mc.lm_UNDER <- function(form,train,test,un,...) {
...
mc.lm_OVER <- function(form,train,test,ov,...) {
...
mc.lm_IS <- function(form,train,test,un,ov,...) {
